...
namespace TalofaGames.UI.PanelSystem
{
  ...
  /// </summary>
  [CreateAssetMenu(menuName = "UI/PanelSystem/PanelStackSystem")]
  public class PanelStackSystem : ScriptableObject, IPanelStackSystem
  {
    ...
    public virtual void ViewDidLoad(PanelStackControllerBehaviour panelStackControllerBehaviour) { }
    public virtual void ViewWillAppear(PanelStackControllerBehaviour panelStackControllerBehaviour) { }
    public virtual void ViewDidAppear(PanelStackControllerBehaviour panelStackControllerBehaviour) { }
    public virtual void ViewDidDisappear(PanelStackControllerBehaviour panelStackControllerBehaviour) { }
    public virtual void ViewWillDisappear(PanelStackControllerBehaviour panelStackControllerBehaviour) { }
